...
export const AppLogo: React.FC<AppLogoProps> = ({
  ...
  const logoIcon = (
    <div className={`relative overflow-hidden border border-emerald-500/30 shadow-md shadow-emerald-500/20 shrink-0 bg-[#0A0E1A] flex items-center justify-center ${sizeClasses} ${className}`}>
      {!imgError ? (
        <img
          src={imgSrc}
