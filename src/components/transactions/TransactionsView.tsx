...
export const TransactionsView: React.FC<TransactionsViewProps> = ({
  ...
  return (
    <div className="space-y-4 pb-24">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          {onClearAllTransactions && transactions.length > 0 && (
            <button
              ...
              className="px-2.5 py-1.5 rounded-xl bg-rose-500/10 hover:bg-rose-500/20 text-rose-600 dark:text-rose-400 font-bold text-xs flex items-center gap-1 cursor-pointer transition-all active:scale-95 border border-rose-200 dark:border-rose-900/50"
      ...
      {showClearAllConfirm && (
        <div className="fixed inset-0 z-50 bg-slate-900/40 dark:bg-black/80 flex items-center justify-center p-4 animate-fadeIn">
          <div className="bg-white dark:bg-[#131926] border border-rose-300 dark:border-red-500/50 max-w-sm w-full p-5 rounded-2xl text-center space-y-3 shadow-2xl">
            <div className="w-12 h-12 rounded-full bg-rose-100 text-rose-700 dark:bg-rose-500/20 dark:text-rose-400 flex items-center justify-center mx-auto">
            ...
            <p className="text-xs text-slate-500 dark:text-[#8899BB] leading-relaxed">
              This will permanently remove all {transactions.length} transaction entries from your ledger state so you can add your transactions manually from scratch.
            </p>
            <div className="flex gap-2 pt-2">
              <button
              ...
              <button
                ...
                className="flex-1 py-2.5 rounded-xl bg-rose-600 hover:bg-rose-700 text-xs font-bold text-white shadow-lg shadow-rose-600/30"
              >
                Confirm & Clear
              </button>
            </div>
